...
export class AuthService {
    ...
    refreshToken() {
        let headers = new HttpHeaders({'Authorization': 'Bearer ' + this.currentUser.refreshToken});
    ...
    getProfile() {
        let headers = new HttpHeaders({'authorization': 'Bearer ' + this.currentUser.accessToken});
